...
describe("form_element_checkbox", function() {
  ...
  it("values hash", function() {
    ...
    var render_actual = form_data.element.elements.test.dom.innerHTML;
    var render_expected = '<span class="form_orig"><input type="checkbox" id="data_test-3" name="data[test][]" value="3"><label for="data_test-3">Three</label></span><span class="form_orig"><input type="checkbox" id="data_test-foo" name="data[test][]" value="foo"><label for="data_test-foo">Foo</label></span><span class="form_orig"><input type="checkbox" id="data_test-1" name="data[test][]" value="1"><label for="data_test-1">One</label></span><span class="form_orig"><input type="checkbox" id="data_test-bar" name="data[test][]" value="bar"><label for="data_test-bar">Bar</label></span><span class="form_orig"><input type="checkbox" id="data_test-bla" name="data[test][]" value="bla"><label for="data_test-bla">Bla</label></span><span class="form_orig"><input type="checkbox" id="data_test-2" name="data[test][]" value="2"><label for="data_test-2">Two</label></span>';
    assert.equal(render_actual, render_expected);
  ...
  it("values complex hash", function() {
    ...
    var render_actual = form_data.element.elements.test.dom.innerHTML;
    var render_expected = '<span class="form_orig"><input type="checkbox" id="data_test-3" name="data[test][]" value="3"><label for="data_test-3">Three</label></span><span class="form_orig"><input type="checkbox" id="data_test-foo" name="data[test][]" value="foo"><label for="data_test-foo">Foo</label><span class="description">Foo Desc</span></span><span class="form_orig"><input type="checkbox" id="data_test-1" name="data[test][]" value="1"><label for="data_test-1">One</label></span><span class="form_orig"><input type="checkbox" id="data_test-bar" name="data[test][]" value="bar"><label for="data_test-bar">Bar</label></span><span class="form_orig"><input type="checkbox" id="data_test-bla" name="data[test][]" value="bla"><label for="data_test-bla">Bla</label></span><span class="form_orig"><input type="checkbox" id="data_test-2" name="data[test][]" value="2"><label for="data_test-2">Two</label></span>';
    assert.equal(render_actual, render_expected);
